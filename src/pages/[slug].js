        ...
        const interval = setInterval(() => {
            ...
            const data = [
                ...
                },
                {
                    ...
                    slug: "thu-hoan",
                    secret: "618c50",
                    quote: "Your intelligence, kindness, and grace make the world a better place. Happy Women's Day!",
                },
                {
                    id: 6,
                    name: "Khánh Huyền",
                    slug: "khanh-huyen",
                    secret: "df25eb",
                    quote: "All best wishes on Women's Day. Keep shining and smiling always!. Happy Women's Day!",
                },
                {
                    id: 7,
                    name: "Đỗ Linh",
    ...
    return (
        <>
            ...
            <div className="unsupported bg-light h-100 w-100 d-flex flex-column justify-content-center align-items-center p-5 text-center">
                <div className="my-2">
                    Sorry, this screen size is not supported. Please access the
                    content using a desktop browser with a wider screen.{" "}
                    <br></br> Thank you.
                </div>
